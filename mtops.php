...
<!-- declare links-->
  ...
  <h1>
    ...
    <div3>
    <p> Filters </p>
    <a href ="wtops.php"><button> Women's </button><br> </a>
    <a href ="mtops.php"><button> Men's </button><br> </a>
    <a href ="ktops.php"><button> Kid's </button><br> </a>
    <br>
  </div3>
  </body>
