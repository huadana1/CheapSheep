<?php require 'server.php'; require 'functions.php'; ?>

<!DOCTYPE html>
<html>
<head>
    <title>Trade Space</title>
...
<body>
    ...
    <div class = "uploads" style = 'width: 80%; margin-right: 0px; float: right;'>
      <?php
        ...
        //Gets logged in user data to make offers
        ...
        // Diplay every image in database
        ...
        while ($row = mysqli_fetch_array($result)) {
          ...
          echo "<p> <strong>User: </strong>$email </p>";
          ...
          echo "<p> <strong>Description: </strong>$image_text </p>";
