...
<!-- declare links-->
  ...
  <h1>
    ...
    <div3>
    <p> Filters </p>
    <a href ="wshoes.php"><button> Women's </button><br> </a>
    <a href ="mshoes.php"><button> Men's </button><br> </a>
    <a href ="kshoes.php"><button> Kid's </button><br> </a>
    <br>
  </div3>
  </body>
